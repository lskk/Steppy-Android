...
public class CalibrateService extends Service {
	private static final String TAG = "Calibrate Service";
    ...
    public void onCreate() {
        ...
        showNotification();
        Tools.updateCountingState(getApplicationContext(), "2");
        // Load settings
        ...
        Toast.makeText(this, "Start Calibrate", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onDestroy() {
        ...
        Toast.makeText(this, "Stop Calibrate", Toast.LENGTH_SHORT).show();
    }
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {
            	...
            	CalibrateService.this.unregisterDetector();
            	CalibrateService.this.registerDetector();
