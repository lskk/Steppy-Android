...
public class StepDetector implements SensorEventListener {
	...
	private ArrayList<SensorListener> mSensorListeners = new ArrayList<SensorListener>();
	...
	public void addSensorListener(SensorListener sl) {
		mSensorListeners.add(sl);
	}
				...
				if (j == 1) {
					...
					if (direction == -mLastDirections[k]) {
						...
						for (SensorListener sensorListener : mSensorListeners) {
							sensorListener.onSensorChanged(diff);
						}
